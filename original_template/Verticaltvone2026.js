...
(lib.Verticaltvone2026 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.SetarCotacao = function (moeda, valor, negativo) {
			...
			}.bind(this), 100); // bind corrige o "this" 
		};
	...
	this.shape.setTransform(360,50);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Cotação
	this.Moeda2 = new lib.Símbolo2();
	this.Moeda2.setTransform(511,65.2,1,1,0,0,0,35,39.1);

	this.Moeda = new lib.Símbolo2();
	this.Moeda.setTransform(410.5,65.2,1,1,0,0,0,35,39.1);
	...
	this.Tempo.setTransform(277.9,69.3,1,1,0,0,0,81.1,50);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.Tempo},{t:this.Tempo2}]}).wait(1));

	// Relógio
	this.DataDia = new lib.datad();
	this.DataDia.setTransform(738.1,184,1,1.001,0,0,0,146.1,153.6);
...
(lib.Símbolo1 = function() {
	...
	this.Temperatura.setTransform(114,11.7);

	this.Icone = new lib.IconesTempo();
	this.Icone.setTransform(201.7,41.4,0.307,0.307,0,0,0,265,87);
	...
	this.Dia.lineWidth = 61;
	this.Dia.setTransform(30.5,14.5);
